...
class pushstate_Settings {

	/**
	 * The single instance of pushstate_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'pushstate' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main pushstate_Settings Instance
	 *
	 * Ensures only one instance of pushstate_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see pushstate()
	 * @return Main pushstate_Settings instance
	 */
