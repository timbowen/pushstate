	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'pushstate' ) . '" data-uploader_button_text="' . __( 'Use image' , 'pushstate' ) . '" class="image_upload_button button" value="'. __( 'Upload new image' , 'pushstate' ) . '" />' . "\n";
